...
export class TeamsApi extends HttpApiGroup.make("teams")
  ...
  .add(
    HttpApiEndpoint.post("createTeam", "/api/teams").setPayload(
      S.Struct({
        name: S.String,
        key: S.String,
      })
...
export class IssuesApi extends HttpApiGroup.make("issues")
  .add(
    HttpApiEndpoint.post("listIssues", "/api/teams/:teamId/issues").setPayload(
      S.Struct({
  ...
  .add(
    HttpApiEndpoint.get("getIssue", "/api/teams/:teamId/issues/:issueId").setSuccess(
      S.Struct({ issue: Issue })
    )
  )
  .add(
    HttpApiEndpoint.post("createIssue", "/api/teams/:teamId/issues").setPayload(
      S.Struct({
        title: S.String,
        description: S.optional(S.String),
        priority: S.String,
  ...
  .add(
    HttpApiEndpoint.patch("updateIssue", "/api/teams/:teamId/issues/:issueId").setPayload(
      S.Struct({
  ...
  .add(
    HttpApiEndpoint.delete("deleteIssue", "/api/teams/:teamId/issues/:issueId").setSuccess(
...
export class ProjectsApi extends HttpApiGroup.make("projects")
  .add(
    HttpApiEndpoint.get("listProjects", "/api/teams/:teamId/projects").setSuccess(
      S.Struct({ projects: S.Array(Project) })
    )
  )
  .add(
    HttpApiEndpoint.get("getProject", "/api/teams/:teamId/projects/:projectId").setSuccess(
 ...
 */
export class WorkflowStatesApi extends HttpApiGroup.make("workflowStates")
  .add(
    HttpApiEndpoint.get("listWorkflowStates", "/api/teams/:teamId/workflow-states").setSuccess(
      S.Struct({ workflowStates: S.Array(WorkflowState) })
    )
  ) { }
